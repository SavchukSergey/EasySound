...
namespace EasySound.Tests {
    [TestFixture]
    public class WavFullReadAudioStreamBits8Test : WavAudioStreamBits8TestBase {

        protected override AudioStream OpenTestStream() {
            return new WavFullReadAudioStream(OpenResource("PNTY_Radio_Music Bed_F-bits8.wav"));
        }
